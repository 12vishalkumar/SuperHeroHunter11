...
/*//----- (calling fetchSuperHeroes with random characters to display 
               a list of superHeroes at homepage without searching) ---------------------*/
                    ...
                    <div class="character-info" class="character-info" >
                        <div class="cardi">
                            <button id = "knowmorejs" class = "knowmorejs">
                                <i class="fa-solid fa-heart fav-icon"></i> &nbsp; Know More 
                            </button>
                        </div>
                    </div>
                </div>
...
//---------------------- (Functions, To Render Again the DOM ) ------------------------>
...
function handleDocumentClick(e) {
    ...
    if (
        ...
        //--------------------------------------- adding id ------------------------->
        FavoriteIdArray.push(FavIDafterClick); 
    ...
    if (
        eventTarget.className === "addToFavBtn" && eventTarget.children[0].id == "rmFAV") {
        FavIDafterClick = 
            e.target.parentElement.parentElement.parentElement.children[0]
            .children[1].children[0].children[0].innerHTML;

        //----------------------------------- removing id -------------------------->
        removeFavArray(FavoriteIdArray, FavIDafterClick); 
...
/*//-------------------------(Function : To Remove the id of superHero, 
                    when Clicked on Remove From Favourite Button)--------------->*/
